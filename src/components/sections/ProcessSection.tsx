  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      paths.forEach((path) => {
        ...
        // Setup iniziale dal CLAUDE.md. NB: Questo override di strokeDasharray maschererà i tratteggi 
        // sostituendoli visivamente con il segmento solido che si "espande".
        gsap.set(path, { strokeDasharray: length, strokeDashoffset: length })
        
        // L'animazione scrub lungo le curve connettore
        gsap.to(path, { 
          strokeDashoffset: 0, 
          ease: 'none', 
          scrollTrigger: { 
  ...
  return (
    <section ref={sectionRef} className="py-24 md:py-36 bg-bg-alt relative overflow-hidden z-10">
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 w-full">
        ...
        <div className="relative flex flex-col md:flex-row items-center md:items-stretch justify-between gap-12 md:gap-6 lg:gap-8 w-full">
